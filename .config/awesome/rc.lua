...
weather = awful.widget.watch('weather', 1000)
cpu = awful.widget.watch('cpu', 10)
spotifyplaying = awful.widget.watch('spotifyplaying', 10)
music = awful.widget.watch('music', 10)
